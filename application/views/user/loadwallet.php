			...
			<div class="col-md-6 col-md-offset-3">
				<div class="wallet-form text-center">
					<div class="form-group">
						<label>Top up your wallet now</label>
						<input class="form-control" type="number" id="amount" name="amount" placeholder="Enter amount to top up">
					</div>
					<div class="form-group">
						<a id="topbtn" href="#loadmoney"><button class="btn btn-fill btn-dark col-sm-12 col-xs-12">Top up now</button></a>
					</div>
				</div>
			</div>
		</div>
